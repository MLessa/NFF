...
namespace NudesForFreeV2.Repositories
{
	public class UserRepository : BaseRepository
	{
        ...
        private static UserRepository pRepository = null;
        public static UserRepository GetInstance()
        {
            if (pRepository == null)
                pRepository = new UserRepository();
            return pRepository;
        }
        ...
        {
            // buildding a command T-SQL
            string commandText = "delete from interaction where userID=@id;delete from comment where userID=@id;delete from post where userID=@id;delete from " + cTableName + " where userID=@id;";
